...
class GPTTranslator:
    def __init__(self, terminology=None, to_CN=True):
        ...
        self.system_prompt = "You are a professional translator.The translation should be professional, complete, and must not omit any words. Do not translate numbers, units of measure, e.g. length, volume, capacity, density, etc. If the text contains 'Ä', multiple adjacent 'Ä's are translated into the same length of '-', for example, 'ÄÄÄ' is translated into '---'. When I ask you for a translation, please reply with the translated text only. If you find there is nothing to translate, just reply with the original text."
